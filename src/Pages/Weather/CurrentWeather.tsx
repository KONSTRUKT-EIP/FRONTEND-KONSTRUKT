  ...
  return (
    <div className="bg-white rounded-2xl p-10 shadow-sm">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        {/* Météo principale */}
        <div className="flex-1 rounded-xl p-10 text-white min-h-[280px] flex flex-col justify-center relative overflow-hidden">
          {/* Image météo visible et prioritaire */}
          <img
            src={backgroundImage}
            fetchPriority="high"
            loading="eager"
