...
const mockWorkers: Record<string, MockWorker[]> = {
  "1": [
    ...
    { id: "w1-6", specialite: "Béton",       name: "Lina Moreau",     email: "l.moreau@konstrukt.fr",    dateDebut: "2025-09-20", status: "Actif", starred: false, initials: "LM", color: "#0ea5e9", teamId: "t1" },
    { id: "w1-7", specialite: "Armature",    name: "Noah Petit",      email: "n.petit@konstrukt.fr",     dateDebut: "2025-10-02", status: "Actif", starred: false, initials: "NP", color: "#84cc16", teamId: "t1" },
    { id: "w1-8", specialite: "Sécurité",    name: "Hugo Vidal",      email: "h.vidal@konstrukt.fr",     dateDebut: "2025-10-18", status: "Actif", starred: true,  initials: "HV", color: "#f59e0b", teamId: "t1" },
    { id: "w1-9", specialite: "Maçonnerie",  name: "Nina Roux",       email: "n.roux@konstrukt.fr",      dateDebut: "2025-11-05", status: "Actif", starred: false, initials: "NR", color: "#22c55e", teamId: "t1" },
    { id: "w1-10", specialite: "Électricité",name: "Tom Giraud",      email: "t.giraud@konstrukt.fr",    dateDebut: "2025-11-18", status: "Actif", starred: false, initials: "TG", color: "#3b82f6", teamId: "t1" },
    { id: "w1-11", specialite: "Plomberie",  name: "Léa Robin",       email: "l.robin@konstrukt.fr",     dateDebut: "2025-12-02", status: "Actif", starred: false, initials: "LR", color: "#14b8a6", teamId: "t1" },
    { id: "w1-12", specialite: "Charpente",  name: "Paul Renaud",     email: "p.renaud@konstrukt.fr",    dateDebut: "2025-12-12", status: "Actif", starred: false, initials: "PR", color: "#a855f7", teamId: "t1" },
    { id: "w1-13", specialite: "Finitions",  name: "Sarah Noel",      email: "s.noel@konstrukt.fr",      dateDebut: "2026-01-03", status: "Actif", starred: false, initials: "SN", color: "#ef4444", teamId: "t1" },
    { id: "w1-14", specialite: "Béton",      name: "Yanis Mercier",   email: "y.mercier@konstrukt.fr",   dateDebut: "2026-01-10", status: "Actif", starred: false, initials: "YM", color: "#06b6d4", teamId: "t1" },
    { id: "w1-15", specialite: "Armature",   name: "Clara Dumont",    email: "c.dumont@konstrukt.fr",    dateDebut: "2026-01-17", status: "Actif", starred: true,  initials: "CD", color: "#16a34a", teamId: "t1" },
    { id: "w1-16", specialite: "Sécurité",   name: "Axel Roche",      email: "a.roche@konstrukt.fr",     dateDebut: "2026-01-24", status: "Actif", starred: false, initials: "AR", color: "#f97316", teamId: "t1" },
    { id: "w1-17", specialite: "Maçonnerie", name: "Inès Pascal",     email: "i.pascal@konstrukt.fr",    dateDebut: "2026-01-31", status: "Actif", starred: false, initials: "IP", color: "#6366f1", teamId: "t1" },
    { id: "w1-18", specialite: "Électricité",name: "Léo Perrin",      email: "l.perrin@konstrukt.fr",    dateDebut: "2026-02-04", status: "Actif", starred: false, initials: "LP", color: "#10b981", teamId: "t1" },
    { id: "w1-19", specialite: "Plomberie",  name: "Maya Guichard",   email: "m.guichard@konstrukt.fr",  dateDebut: "2026-02-07", status: "Actif", starred: false, initials: "MG", color: "#f43f5e", teamId: "t1" },
    { id: "w1-20", specialite: "Charpente",  name: "Ethan Colin",     email: "e.colin@konstrukt.fr",     dateDebut: "2026-02-10", status: "Actif", starred: false, initials: "EC", color: "#8b5cf6", teamId: "t1" },
    { id: "w1-21", specialite: "Finitions",  name: "Zoé Vasseur",     email: "z.vasseur@konstrukt.fr",   dateDebut: "2026-02-13", status: "Actif", starred: false, initials: "ZV", color: "#0ea5e9", teamId: "t1" },
    { id: "w1-22", specialite: "Béton",      name: "Milan Delorme",   email: "m.delorme@konstrukt.fr",   dateDebut: "2026-02-16", status: "Actif", starred: false, initials: "MD", color: "#84cc16", teamId: "t1" },
    { id: "w1-23", specialite: "Armature",   name: "Jade Fabre",      email: "j.fabre@konstrukt.fr",     dateDebut: "2026-02-19", status: "Actif", starred: false, initials: "JF", color: "#f59e0b", teamId: "t1" },
    { id: "w1-24", specialite: "Sécurité",   name: "Rayan Armand",    email: "r.armand@konstrukt.fr",    dateDebut: "2026-02-22", status: "Actif", starred: false, initials: "RA", color: "#22c55e", teamId: "t1" },
    { id: "w1-25", specialite: "Maçonnerie", name: "Lou Maret",       email: "l.maret@konstrukt.fr",     dateDebut: "2026-02-24", status: "Actif", starred: false, initials: "LM", color: "#3b82f6", teamId: "t1" },
    { id: "w1-26", specialite: "Électricité",name: "Sami Bernard",    email: "s.bernard2@konstrukt.fr",  dateDebut: "2026-02-26", status: "Actif", starred: false, initials: "SB", color: "#14b8a6", teamId: "t1" },
    { id: "w1-27", specialite: "Plomberie",  name: "Nora Alix",       email: "n.alix@konstrukt.fr",      dateDebut: "2026-02-28", status: "Actif", starred: false, initials: "NA", color: "#a855f7", teamId: "t1" },
    { id: "w1-28", specialite: "Charpente",  name: "Tiago Colin",     email: "t.colin@konstrukt.fr",     dateDebut: "2026-03-01", status: "Actif", starred: false, initials: "TC", color: "#ef4444", teamId: "t1" },
    { id: "w1-29", specialite: "Finitions",  name: "Eva Perret",      email: "e.perret@konstrukt.fr",    dateDebut: "2026-03-02", status: "Actif", starred: false, initials: "EP", color: "#06b6d4", teamId: "t1" },
    { id: "w1-30", specialite: "Béton",      name: "Adam Rey",        email: "a.rey@konstrukt.fr",       dateDebut: "2026-03-03", status: "Actif", starred: true,  initials: "AR", color: "#16a34a", teamId: "t1" },
    { id: "w1-31", specialite: "Armature",   name: "Lila Monnier",    email: "l.monnier@konstrukt.fr",   dateDebut: "2026-03-04", status: "Actif", starred: false, initials: "LM", color: "#f97316", teamId: "t1" },
    { id: "w1-32", specialite: "Sécurité",   name: "Noé Clément",     email: "n.clement@konstrukt.fr",   dateDebut: "2026-03-05", status: "Actif", starred: false, initials: "NC", color: "#6366f1", teamId: "t1" },
  ],
  "2": [
...
const mockAttendanceData: Record<string, MockAttendanceWeek> = {
  "1": {
    ...
    attendances: {
      ...
      "w1-6": ["present", "present", "present", "present", "present"],
      "w1-7": ["present", "retard",  "present", "present", "present"],
      "w1-8": ["present", "present", "present", "retard",  "present"],
      "w1-9": ["present", "absent",  "present", "present", "present"],
      "w1-10": ["present", "present", "present", "present", "retard"],
      "w1-11": ["retard",  "present", "present", "present", "present"],
      "w1-12": ["present", "present", "conge",   "conge",   "present"],
      "w1-13": ["present", "present", "present", "present", "present"],
      "w1-14": ["present", "retard",  "present", "present", "present"],
      "w1-15": ["present", "present", "present", "present", "present"],
      "w1-16": ["en-attente", "present", "present", "present", "present"],
      "w1-17": ["present", "present", "present", "retard",  "present"],
      "w1-18": ["present", "present", "absent",  "present", "present"],
      "w1-19": ["present", "present", "present", "present", "present"],
      "w1-20": ["retard",  "present", "present", "present", "present"],
      "w1-21": ["present", "present", "present", "present", "conge"],
      "w1-22": ["present", "present", "present", "present", "present"],
      "w1-23": ["present", "absent",  "present", "present", "present"],
      "w1-24": ["present", "present", "present", "retard",  "present"],
      "w1-25": ["present", "present", "present", "present", "present"],
      "w1-26": ["present", "present", "retard",  "present", "present"],
      "w1-27": ["conge",   "conge",   "present", "present", "present"],
      "w1-28": ["present", "present", "present", "present", "present"],
      "w1-29": ["present", "retard",  "present", "present", "present"],
      "w1-30": ["present", "present", "present", "present", "present"],
      "w1-31": ["present", "present", "absent",  "present", "present"],
      "w1-32": ["present", "present", "present", "present", "present"],
    },
  },
  "2": {
    days:  ["Lun 9", "Mar 10", "Mer 11", "Jeu 12", "Ven 13"],
...
export default function DashboardDetail() {
  ...
  const handleWorkerClick = (worker: MockWorker) => {
